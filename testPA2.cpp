...
int main() 
{
    ...
    Test0.push_back(Card(Card::Diamond, 12));
    Test0.push_back(Card(Card::Heart,   13));
    Test0.push_back(Card(Card::Spade,    6));
    Test0.push_back(Card(Card::Heart,   12));
    Test0.push_back(Card(Card::Spade,    6));
    Test0.push_back(Card(Card::Diamond,  6));
    Test0.push_back(Card(Card::Heart,   10));

    Test1.push_back(Card(Card::Spade,   10));
    Test1.push_back(Card(Card::Diamond,  9));
    Test1.push_back(Card(Card::Heart,   12));
    Test1.push_back(Card(Card::Heart,   11));
    Test1.push_back(Card(Card::Diamond, 13));
    Test1.push_back(Card(Card::Club,     7));
    Test1.push_back(Card(Card::Heart,    3));

    Test2.push_back(Card(Card::Spade,   14));
    Test2.push_back(Card(Card::Heart,    7));
    Test2.push_back(Card(Card::Heart,    4));
    Test2.push_back(Card(Card::Heart,    8));
    Test2.push_back(Card(Card::Heart,    6));
    Test2.push_back(Card(Card::Heart,    5));
    Test2.push_back(Card(Card::Heart,   14));

    Test3.push_back(Card(Card::Diamond, 14));
    Test3.push_back(Card(Card::Spade,    6));
    Test3.push_back(Card(Card::Heart,    6));
    Test3.push_back(Card(Card::Heart,    3));
    Test3.push_back(Card(Card::Heart,   10));
    Test3.push_back(Card(Card::Heart,    8));
    Test3.push_back(Card(Card::Heart,    7));
    
    Test4.push_back(Card(Card::Club,     3));
    Test4.push_back(Card(Card::Heart,   11));
    Test4.push_back(Card(Card::Diamond,  9));
    Test4.push_back(Card(Card::Club,    11));
    Test4.push_back(Card(Card::Diamond, 11));
    Test4.push_back(Card(Card::Spade,   14));
    Test4.push_back(Card(Card::Club,    11));
    
    PokerHand testH[FIVE];
